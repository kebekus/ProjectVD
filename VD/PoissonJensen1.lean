...
This file establishes the Poisson-Jensen formula `poissonJensen`, expressing the logarithm of the
norm of the trailing coefficient of a meromorphic function in terms of a circle average and a finite
sum over its divisor.
-/
